...
repos=(
    ...
    #SUSE-Cloud-4-Pool     # not needed since we have installation media
    # SUSE-Cloud-4-Updates # not needed since we're using a Devel:Cloud:4:Staging .iso
...
function setup_overlay {
    ...
    bind_mount /mnt/suse-cloud-4-deps $tftpboot/suse-11.3/install
